...
with tf.Session() as sess:
    ...
    print('test accuracy for MNIST %g' % accuracy.eval(feed_dict={x: mnist.test.images, y_: mnist.test.labels, keep_prob: 1.0}))
    print('test accuracy for USPS %g' % accuracy.eval(feed_dict={x: train[0:999,], y_: train_label[0:999,], keep_prob: 1.0}))
